...
<head>
    ...
    <title>Halaman Utama - Toko Mainan</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css" rel="stylesheet">
    <style>
        /* Gaya untuk membuat gambar memiliki animasi hover */
        .card-img-top {
            transition: transform 0.3s ease; /* Durasi dan kehalusan animasi */
            cursor: pointer; /* Menampilkan cursor pointer */
        }

        .card-img-top:hover {
            transform: scale(1.1); /* Gambar akan diperbesar 10% saat hover */
        }
